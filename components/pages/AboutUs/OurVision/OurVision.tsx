    ...
    <section className="ourvision-section position-relative">
      <div className="ourvision-section-wrap">
        <div className="ourvision-title-wrap">
          ...
          <div className="d-flex align-items-center justify-content-between ourvision-image-content" data-aos="fade-right">
            <Image
            ...
            <div className="our-vision-content" data-aos="fade-left">
              <p>
